        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillsUtilities = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    GroceryDining = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    Shopping = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Medical = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Investing = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Misc = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UserImage = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    FName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Darkmode = table.Column<bool>(type: "bit", nullable: false),
                    Locale = table.Column<string>(type: "nvarchar(1)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsers", x => x.Uid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimeStamp = table.Column<byte[]>(type: "varbinary(900)", nullable: false),
